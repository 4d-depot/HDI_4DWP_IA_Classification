...
Case of 
	...
	Else 
		...
		$options.title:="Categorize 4D Write Pro documents"+$cr+"using AI"
		...
		Else 
			...
			$win:=Open form window:C675("DocumentList"; Plain form window:K39:10; Horizontally centered:K39:1; Vertically centered:K39:4)
			DIALOG:C40("DocumentList")
			CLOSE WINDOW:C154
